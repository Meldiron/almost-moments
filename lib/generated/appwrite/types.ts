    ...
    galleries: {
      ...
      list: (options?: {
        queries?: (q: {
          ...
          select: <K extends keyof Galleries>(fields: K[]) => string;
      ...
      }) => Promise<{ total: number; rows: Galleries[] }>;
    };
    galleryAssets: {
      create: (
        data: {
      ...
      list: (options?: {
        queries?: (q: {
          ...
          select: <K extends keyof GalleryAssets>(fields: K[]) => string;
          orderAsc: <K extends keyof GalleryAssets>(field: K) => string;
          orderDesc: <K extends keyof GalleryAssets>(field: K) => string;
          limit: (value: number) => string;
          offset: (value: number) => string;
          cursorAfter: (documentId: string) => string;
          cursorBefore: (documentId: string) => string;
      ...
      }) => Promise<{ total: number; rows: GalleryAssets[] }>;
    };
  };
};
